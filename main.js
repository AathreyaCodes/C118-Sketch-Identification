...
document.getElementById("todraw").value = document.getElementById("todraw").value + element_of_array;
...
function check_sketch(){
    ...
    document.getElementById("timer").value = document.getElementById("timer").value + timer_counter;
